...
const milestones = [
	{
		...
		title: "Der Anfang",
		description:
			"Alles begann mit einem Traum und einem kleinen Ofen. Das Team wagte den Sprung – mit Leidenschaft.",
	},
	{
		year: "2015",
		title: "Erste Stammgäste",
		description:
			"Wort hat sich rumgesprochen. Die ersten Stammgäste kamen – und kommen bis heute. Manche sogar jeden Tag.",
	},
	{
		year: "2018",
		title: "Die Kids steigen ein",
		description:
			"Aus dem Familienprojekt wurde ein echter Familienbetrieb. Jetzt helfen alle vier mit – jeder auf seine Art.",
	},
	{
		year: "2022",
		title: "12 Jahre Erfahrung",
		description:
			"Über ein Jahrzehnt Leidenschaft, tausende Pizzen, unzählige glückliche Gesichter. Wir haben noch lange nicht genug.",
	},
	{
		year: "2025",
		title: "Neuer Standort, neue Energie",
		description:
			"AMICIZIA hat ein neues Zuhause gefunden – Industriestraße 20 in Saarlouis. Frischer Look, gleiche Liebe.",
	},
	{
		year: "Zukunft",
		...
		>
			...
			<div className="max-w-7xl mx-auto">
				<div className="text-center mb-20">
					...
					>
						12+ Jahre{" "}
						<span className="text-bordeaux">Geschichte</span>
					</motion.h2>
